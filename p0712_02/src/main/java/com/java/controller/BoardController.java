...
//        mv.addObject("countAll",map.get("countAll"));
    ...
    public ModelAndView update(BoardDto bdto, @RequestParam(defaultValue = "1") int page) {
    ...
    public String doUpdate(BoardDto bdto, @RequestPart MultipartFile files, @RequestParam(defaultValue = "1")int page) {
