...
public class EmailServiceImpl implements EmailService {
	...
	public void email_send(String name, String email) {
		...
		message.setTo(email);
		message.setFrom("hyeonmuk97@gmail.com");
		message.setSubject(name+"의 비밀번호가 초기화 되었습니다.\n");
	...
	public void email_send2(String name, String email) {
		...
		try {
			message.setSubject("[안내]"+name+"의 비밀번호가 초기화 되었습니다.","utf-8");
			String htmlData = "<tr>	\r\n"
			...
			// 보내는 이메일 주소
			message.setFrom(new InternetAddress("hyeonmuk97@gmail.com"));
			// 받는 이메일 주소
