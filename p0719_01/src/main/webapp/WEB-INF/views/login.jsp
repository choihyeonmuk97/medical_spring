...
<body>
  ...
  <section>
    ...
    <form action="/login" name="login" method="post">
      ...
      <br><br>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=46aebf8f45d2156ebb99479830ce2694&redirect_uri=http://localhost:8181/kakao/oauth">
